...
module.exports = {
  async up(queryInterface, Sequelize) {
    await queryInterface.bulkInsert("Posts", [
      {
        title: "Test Title1 (user1)",
        content: "Test Content1 (user1)",
        userId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        title: "Test Title2 (user1)",
        content: "Test Content2 (user1)",
        userId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
      {
        title: "Test Title3 (user1)",
        content: "Test Content3 (user1)",
        userId: 1,
        createdAt: new Date(),
        updatedAt: new Date(),
      },
